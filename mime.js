...
(function() {
  var Magic, Mime, magic, mimetype, mmm, stream,
  ...
  Mime = (function(superClass) {
    ...
    Mime.prototype.check = function() {
      ...
      if (typeof type === "undefined" || type === null) {
        buffer = this._readableState.buffer.concat(this._readableState.length, 'binary');
        return magic.detect(buffer, (function(_this) {
